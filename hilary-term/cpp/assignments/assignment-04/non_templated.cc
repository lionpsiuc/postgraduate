 ...
 * 	Copy main function to templated.cc and then write a templated function
 * at the top which can replace all four function definitions below.
 * @author R. Morrin
 * @version 1.0
 * @date 2025-02-25
 */
...
/**
 * @brief Function to compute the dot product of two vectors stored as C-style
 * arrays Note that normally, I would be making better use of const here.
